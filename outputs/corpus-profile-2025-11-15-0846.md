...
|--------|------|--------|-------|-----|-----|-------|
| ESD (Evidential Support Density) | 1.66 | 1.16 | 1.39 | 0.00 | 4.59 | 4.59 |
| TCI (Transparency Completeness) | 0.99 | 1.00 | 0.02 | 0.94 | 1.00 | 0.06 |
| SCS (Scope Constraints) | 3.90 | 0.50 | 5.76 | 0.00 | 17.00 | 17.00 |
...
**Distribution:** Roughly symmetric (mean ≈ median).

**Example papers:**

- **Low ESD (best):** Introducing Preregistration of Research Design to ... (2021, score=0.0)
- **Moderate ESD:** Deploying an Offline, Multi-User, Mobile System fo... (2021, score=1.11)
- **High ESD (needs review):** Barbarophonos: Language and Panhellenism in the Il... (2005, score=4.59)
...
**Papers with no limitations extracted:** 5/10 (50%)

**Distribution:** Extremely right-skewed. Most papers have few/no limitations, some have many.

**Example papers:**

- **No limitations:** Environmental conditions in the SE Balkans since t... (2013, score=0)
- **Moderate limitations:** Validating predictions of burial mounds with field... (2024, score=1)
...
**Overall homogeneity:** Low (heterogeneous corpus). Papers vary widely across metrics. Diverse corpus or wide quality range.
...
**High-variance metrics (CV > 1.0):** SCS
- These metrics show substantial variation across corpus. Good discriminating power.
...
**Profile generated:** 2025-11-15 08:46:28
