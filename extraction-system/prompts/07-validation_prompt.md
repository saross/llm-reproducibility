# Validation Prompt - PASS 7: Integrity Checks v2.7
...
Perform automated integrity checks on the complete extraction (Passes 0-6). Identify structural issues, broken references, schema violations, and completeness gaps. **Do NOT modify the extraction** - produce a validation report only.

**This is NOT quality assessment** - you are checking structural integrity, not methodological quality.

**Input:** JSON extraction document from Passes 0-6
...
## Infrastructure Assessment Reference Files

**For context on validating infrastructure extraction (Pass 6):**

**PIDs and connectivity:**
→ See `references/infrastructure/pid-systems-guide.md` for PID format validation, resolver URL patterns, ORCID coverage categories, PID graph connectivity scoring

**FAIR assessment:**
→ See `references/infrastructure/fair-principles-guide.md` for FAIR scoring criteria, machine-actionability definitions, metadata richness standards, controlled vocabulary usage, software reproducibility levels, context-dependent expectations

**Permits and CARE:**
→ See `references/infrastructure/fieldwork-permits-guide.md` for permit types, CARE principles framework, ethical restrictions assessment

**Author contributions:**
→ See `references/infrastructure/credit-taxonomy.md` for CReDIT taxonomy (14 roles), format variations
...
**Check enum fields against schema v2.7 allowed values.**
...
Schema v2.7 requires all Research Designs, Methods, and Protocols to be properly sourced. Verify:
